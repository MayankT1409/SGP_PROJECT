...
//         allMarkers.forEach(({ site, location }) => {
...
//             const content = `
//               <div class="p-4 max-w-sm bg-white rounded-lg shadow-md">
//                 <h3 class="text-lg font-semibold text-gray-900 mb-2">${site.MONUMENT}</h3>
//                 <p class="text-sm text-gray-600 mb-2">${site.STATE}</p>
//                 <p class="text-xs text-gray-500">Location: ${location.lat.toFixed(4)}, ${location.lng.toFixed(4)}</p>
//               </div>
//             `;
//             infoWindowRef.current.setContent(content);
//             infoWindowRef.current.open(googleMapRef.current, marker);
...
//     const location = selectedSite.site
//       ? { lat: selectedSite.site.LATITUDE, lng: selectedSite.site.LONGITUDE }
//       : null;
