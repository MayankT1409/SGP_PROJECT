...
//   // //   const months = [
//   // //     ...new Set(
//   // //       festivalData.map((festival) => festival.month).filter((m) => m && m !== "-1")
//   // //     ),
//   // //   ].sort((a, b) => a.localeCompare(b));

//   // //   const handleMonthClick = (month) => {
//   // //     setSelectedMonth(month);
//   // //     const filtered = festivalData.filter((festival) => festival.month === month);
...
//   // //                 {festival.name}
//   // //               </h3>
//   // //               <p className="text-amber-700 text-sm">{festival.month}</p>
//   // //               <p className="text-gray-600 text-sm mt-2">{festival.description}</p>
//   // //               <p className="text-gray-400 text-xs mt-1">{festival.region}</p>
//   // //             </div>
//   // //           ))}
//   // //         </div>
//   // //       </main>
...
// //   // Get unique & sorted months (alphabetically)
...
//   // Get unique & sorted months (alphabetically, case-insensitive)
//   const months = useMemo(() => {
//     return [
//       ...new Set(
//         festivals.map((festival) => festival.month).filter((m) => m && m !== "-1")
